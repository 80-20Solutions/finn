...
///
/// // Fetch all methods
/// final result = await repository.getPaymentMethods(userId: currentUserId);
/// result.fold(
///   (failure) => print('Error: ${failure.message}'),
///   (methods) => print('Loaded ${methods.length} methods'),
/// );
///
/// // Create custom method
/// final createResult = await repository.createPaymentMethod(
///   userId: currentUserId,
///   name: 'PayPal',
/// );
///
/// // Check if name exists (for validation)
/// final exists = await repository.paymentMethodNameExists(
///   userId: currentUserId,
///   name: 'paypal',  // Case-insensitive
/// );
///
/// // Delete with usage check
/// final count = await repository.getPaymentMethodExpenseCount(id: methodId);
/// if (count.getOrElse(() => 0) > 0) {
///   showError('Cannot delete: used by $count expenses');
/// } else {
///   await repository.deletePaymentMethod(id: methodId);
/// }
///
/// // Real-time subscription
/// repository.watchPaymentMethods(userId: currentUserId).listen(
///   (methods) => updateUI(methods),
/// );
/// ```
